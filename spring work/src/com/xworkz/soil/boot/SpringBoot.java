...
import com.xworkz.soil.entity.Door;
...
public class SpringBoot {
	...
	public static void main(String[] args) {
		...
		bean.produceFood();
		System.out.println(context.getBean(Air.class).hashCode());
		System.out.println(context.getBean(Ant.class).hashCode());
		System.out.println(context.getBean(Apple.class).hashCode());
		System.out.println(context.getBean(Door.class).hashCode());
		...
		System.out.println(context.getBean(Mirror.class).hashCode());
